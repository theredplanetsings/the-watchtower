...
const translations = {
    en: {
      ...
      loaderText: "Entering Tip Line Dashboard...", //initial loading text
    ...
    es: {
      ...
      loaderText: "Entrando en el Tablero de Denuncias...", //initial loading text
    ...
    fr: {
      ...
      loaderText: "Entrée dans le Tableau de Bord des Lignes de Signalement...", //initial loading text
    ...
    ru: {
      ...
      loaderText: "Вход в Панель Горячих Линий...", //initial loading text
    ...
    zh: {
        ...
        loaderText: "正在进入举报面板...", //initial loading text
      ...
      de: {
        ...
        loaderText: "Betrete ds Hinweis-Dashboard...", //initial loading text
